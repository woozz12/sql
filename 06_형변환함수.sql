...
SELECT first_name, TO_CHAR(hire_date, 'YYYY"년" MM"월" DD"일" DAY')
FROM employees;
...
SELECT TO_CHAR(20000.29, '99999.9') FROM dual; --반올림도 된다
SELECT TO_CHAR(20000, '99,999') FROM dual; --,붙여서
